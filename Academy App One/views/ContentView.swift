...
struct ContentView: View {
                            ...
                            VStack(alignment: .leading, spacing:12){
                                ...
                                VStack(alignment: .leading, spacing:20){
                                    HStack{
                                        ...
                                        Text("Years").font(.title3).fontWeight(.light)
                                ...
                                VStack(alignment:.leading, spacing:12){
                                    ...
                                    VStack{
                                        HStack{
                                            ...
                                            Text("cm").font(.title2).fontWeight(.light)
                                        }
                                ...
                                VStack(alignment:.leading,spacing:12){
                                    ...
                                    VStack{
                                        HStack{
                                            ...
                                            Text("kg").font(.title2).fontWeight(.light)
                                        }
    ...
    private func isFormValid() -> Bool {
        ...
        let isHeightValid = heightConverted >= 50 && heightConverted <= 300
        let isWeightValid = weightConverted >= 5 && weightConverted <= 500
...
struct GenderOptionView: View {
    ...
    var body: some View {
        VStack(alignment: .center, spacing: 16) {
            ...
            Text(label)
                .foregroundColor(isSelected ? .black : .primary).fontWeight(.regular)
        }
        .frame(maxWidth: .infinity)
        .frame(height: 140)
        .background(
